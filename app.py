...
st.caption(
    "Machine Learning Powered Retail Forecasting & Inventory Optimization Platform"
)
...
if st.button("Predict Demand"):
    ...
    if current_stock < predicted_sales:
        ...
        st.error(f"⚠ Stockout Risk! Short by {shortage} units")
    else:
        surplus = current_stock - predicted_sales
        st.success(f"✅ Stock Level Safe ({surplus} units buffer)")
